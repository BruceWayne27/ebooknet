    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 col-xs-12">
            <table class="table table-hover">
                <caption class="h4">"<span class="text-primary" style="color: wheat">${searchTxt} 的搜索结果</span>"
                    <span class="pull-right small"style="color: red">共${books.size()}条记录</span></caption>
                <thead>
                <tr>
                    <th class="col-md-2 col-xs-6" style="color:white">封面</th>
                    <th class="col-md-2 col-xs-6" style="color:white">书名</th>
                    <th class="col-md-2 col-xs-6" style="color:white">作者</th>
                    <th class="col-md-2 col-xs-6" style="color:white">出版时间</th>
                    <th class="col-md-4 col-xs-12" style="color:white">简介</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <c:forEach items="${books}" var="book">
                        <tr>
                            ...
                            <td class="bookInfo"><a href="bookDetail?bookID=${book.id}" class="btn btn-link" title="${book.book_title}" style="color: #000000;font-weight: bold">${book.book_title}</a></td>
